...
namespace TrabalhoFinal
{
    class PedidoDAO
    {
        ...
        public void FechaTodosAbertos()
        {
            Database dbDelivery = Database.GetInstance();

            String qry = "UPDATE pedido_dados set flagStatus = 3, situacao = 'Fechado', fechamentoPedido=sysdate() where nro in (select nro where flagStatus != 3);";
